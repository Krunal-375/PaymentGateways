    ...
    <main className="flex py-16 com flex-col items-center justify-between container mx-auto">
      <div className="z-10 px-4 w-full items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          ...
          <Link
            ...
            href="https://github.com/Krunal-375/PaymentGateways"
            target="_blank"
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:size-auto lg:bg-none">
          <Link
            ...
            href="https://github.com/Krunal-375"
            target="_blank"
            rel="noopener noreferrer"
          >
            By <span className="text-2xl tracking-tighter">Krunal Dhapodkar</span>
          </Link>
        </div>
      </div>
      ...
      <div className="mb-32 mt-20 px-4 grid text-center gap-4 lg:mb-0 w-full sm:grid-cols-2 lg:grid-cols-3  sm:text-left">
        {gateways.map((gateway, index) => (
          <div
            key={index}
            className={`group rounded-lg px-5 py-4 transition-colors hover:bg-gray-100 hover:dark:bg-neutral-800/30 relative ${gateway.active ? 'border-2 border-green-500' : 'border border-transparent hover:border-gray-300 hover:dark:border-neutral-700'}`}
          >
            {gateway.active && (
